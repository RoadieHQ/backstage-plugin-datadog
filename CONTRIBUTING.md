# Contributing to the Backstage Datadog plugin

We want the Backstage Datadog plugin to become the best possible Datadog plugin for Backstage. This is an ambitious goal, and we can't do it without the support of the community.
...
The Backstage Datadog plugin is released under the Apache 2.0 License, and original creations contributed to this repo are accepted under the same license.
...
No one likes bugs. Report bugs as an issue [here](https://github.com/RoadieHQ/backstage-plugin-datadog/issues/new?assignees=&labels=bug&template=bug_template.md).
...
The best way to send feedback is to file [an issue](https://github.com/RoadieHQ/backstage-plugin-datadog/issues/new).
...
Have you started using the Backstage Datadog plugin. Adding your company to [ADOPTERS](https://github.com/RoadieHQ/backstage-plugin-datadog/blob/main/ADOPTERS.md) really helps the project.
...
See [SECURITY.md](https://github.com/RoadieHQ/backstage-plugin-datadog/blob/main/SECURITY.md)
